...
public class IncidentFragment extends BaseFragment {
    ...
    private View.OnClickListener mReloadOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Call findFeedCall = mCCService.inciFeed("6563064899960832",pid,pageNumber);
...
//                    showReloadSnackbar("Can't load data. Check your network connection.");
    ...
    public static IncidentFragment newInstance(Bundle extras) {
...
//        BusProvider.getInstance().register(this);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        rvPasser.rvPassfromIncidentFeed(collegeFeedRecyclerView, mFeedAdapter);
...
//        String collegeId= SharedpreferenceUtility.getInstance(this.getContext()).getString(AppConstants.COLLEGE_ID);
    ...
    public interface  RVPass{
        public void rvPassfromIncidentFeed(RecyclerView personalFeedRecyclerView, CollegeCampusFeedAdapter mfeedAdapter);
    }
    // endregion
}
