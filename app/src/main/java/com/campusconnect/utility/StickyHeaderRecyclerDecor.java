...
public class StickyHeaderRecyclerDecor extends RecyclerView.ItemDecoration {
  ...
  public StickyHeaderRecyclerDecor(StickyRecyclerHeadersAdapter adapter) {
    this(adapter, new LinearLayoutOrientationProvider(), new DimensionCalculator());
  }

  private StickyHeaderRecyclerDecor(StickyRecyclerHeadersAdapter adapter, OrientationProvider orientationProvider,
  ...
  private StickyHeaderRecyclerDecor(StickyRecyclerHeadersAdapter adapter, HeaderRenderer headerRenderer,
